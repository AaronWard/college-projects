...
public class wealthBuilder extends JxFrame 
  implements ListSelectionListener, ActionListener {
    ...
    private Vector Bonds, Stocks, Mutuals, JapaneseStock;   //3 lists of investments
    ...
    private void buildStockLists() {
        ...
        /** Comment out to change UI   **/
        JapaneseStock = new Vector();
        JapaneseStock.addElement("Konami");
        JapaneseStock.addElement("Oculus");
        JapaneseStock.addElement("Sony");
        JapaneseStock.addElement("Miamoto Cars");
        JapaneseStock.addElement("Kojima Productions");
        JapaneseStock.addElement("Sushi Inc.");
    }
    //----------------------------------
