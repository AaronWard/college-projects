...
/**
 *
 * The modified constructor throws a new SingletonException when the sunList
 * vector has a bigger than 1
 * 
 * A JOptionPane is displayed when the exception is thrown 
 */
private Sun(String name, SolarSystem solarSystem) throws SingletonException {
		if(sunList.size() == 0){
			this.name = name;
			...
			JOptionPane.showMessageDialog(null, "Too many suns have been added to your solar system", "Sun Error",JOptionPane.ERROR_MESSAGE);
			throw new SingletonException("Too many suns mate");
		}
	}
